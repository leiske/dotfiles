...
lsp.on_attach(function(client, bufnr)
  ...
  vim.keymap.set("n", "gd", "<cmd>Telescope lsp_definitions<CR>", optsWithDesc("(g)o to (d)efinition"))
  vim.keymap.set("n", "gi", "<cmd>Telescope lsp_implementations<CR>", optsWithDesc("(g)o to (d)efinition"))
  vim.keymap.set("n", "gr", "<cmd>Telescope lsp_references<CR>", optsWithDesc("Show (v)im (r)efe(r)ences"))
